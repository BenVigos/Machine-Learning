...
class Player(player.Player):
    ...
    """
    def __init__(self, state_size = None, action_size = None, MEMORY_SIZE = 1, EPSILON = 0, LEARNING_RATE = 0, BATCH_SIZE = 32, GAMMA = 0, EPSILON_MIN = 0, EPSILON_DECAY = 0, model = None):
        """
